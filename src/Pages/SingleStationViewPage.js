...
import  MapLeaflet from "../Components/Header"
...
//First presentation of the page
 ...
 const onBack = () => {
  ...
  },
  {
    ...
    detailInformation : ! loading ?`${(singleStationDataSource2.averageDistanceofstationDeparture/1000).toFixed(2) } km` : "" 
  },
  {
    key :  '8',
    stationData : ! loading ?'Average distance to station': "",
    detailInformation :  ! loading ?`${(singleStationDataSource2.averageDistanceofstationArrival/1000).toFixed(2)} km` : ""
  },
  {
    key :  '9',
    stationData : ! loading ?'Total number of journeys starting from the station': "",
    detailInformation : singleStationDataSource2.stationDepartureNum
  },

  {
    key :  '9',
    stationData : ! loading ? 'Total number of journeys ending at the station': "",
    detailInformation : singleStationDataSource2.stationArrivalNum
  },

  {
    key :  '10',
    stationData : ! loading ?'Top 5 most popular return stations for journeys starting from the station': "",
    detailInformation : singleStationDataSource2.popular5start
  },

  {
    key :  '11',
    stationData : ! loading ?'Top 5 most popular departure stations for journeys ending at the station': "",
